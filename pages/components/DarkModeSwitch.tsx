...
export default function DarkModeSwitch(){
    ...
    return(
        <div onClick={toggleSwitch} className={`flex-start flex h-[40px] w-[70px] rounded-[50px] bg-zinc-700 p-[5px] shadow-inner hover:cursor-pointer dark:bg-zinc-100 z-50 ${ isOn && 'place-content-end'}`}>
